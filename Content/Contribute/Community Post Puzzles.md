...
The hexadecimal translates as such:
...
While the letters in-between spell out the following phrase when put together:

```
but it will be soon
```

[[ERE IS ONE PERSON I KNOW IT'S KE]] was uploaded 2 days after this was community post, which contains a possible clue to what this riddle might entail:
