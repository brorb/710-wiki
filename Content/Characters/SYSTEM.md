...
_SYSTEM_ (also known as _SYSTEMterminal8_) was originally created by [[INDI]] as a .PCV package to be sent to [[REN]] servers (as SYSTEM explained in SERVER 01, see below), before [[INDI]] made it a moderator for the [[STATION_8 TERMINAL 8]] livestream instead. However, it was hijacked and captured in the livestream by presumably "[[He]]", until it escaped sometime after the livestream ended. It is a critical character within the [[710 Tone]] universe, since it interacts with [[The Sleuths]] directly through their [Discord server](710 Tone Sleuths) and answers question about the lore surrounding [[710 Tone]].
...
[[01.wav]], [[02.wav]], [[03.wav]], [[04.wav]], [[05.wav]], [[06.wav]]. These .wav files were SSTV audio files that gave out the [[Channel 14]] Schedual when decoded.
...
However, during the second Logged Session 3, a new command appeared in the Terminal Storage menu:
...
However, there were certain topics that SYSTEM couldn't discuss due to certain restrictions placed by [[INDI]] (insert discord message citation here), or because the topic itself would make it crash. A great example of this is whenever the topic of [[The Eyes]] are brought up:
