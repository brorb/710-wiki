...
infobox:
  ...
  image:
    ...
    caption: "Travis' parting gift according to [[SYSTEM]], found through
      [[prj_home.exe]]."
  items:
    - label: Appearances
      value:
...
In [[STATION_8 TRIM 5]], Travis (through [7/10 Tone](obsidian://open?vault=710-wiki&file=Content%2FYouTube%2F710%20Tone)) and [[INDI]] (through [[710 NPP]]) shared the following chat messages:
```
...
He created [[prj_home.exe]] as a way to hide a message for anyone archiving the surroundings of 7/10 Tone in the form of lm-2 and the 3 script within the game's files.
