...
A chat member suggests to [[INDI]] that he gives them a PGP key to privately communicate with each other, but [[710 NPP|7/10 NPP]] steps in to tell them that they might not know what [[INDI]] actually is. Another chat member asks if [[INDI]] is a robot, to which [[710 NPP|7/10 NPP]] says he isn't but it's something close to one, with the key to figuring what he is in his name (IN_DI). Eventually, [[710 NPP|7/10 NPP]] says that he has more important things to worry about over than babysitting [[INDI]], he asks [[INDI]] if he could trusted to not speak to anyone else, to which [[INDI]] simply says "FINE."

Streams proceeds as normal, then the next day of the broadcast a chat member mentions [[TRUTH.zip]], asking [[INDI]] when they could get the file. [[INDI]] doesn't answer right away, seemingly trying to keep his promise to [[Kepler]], until he eventually inquires the chat member about how they know about the file and where they got the information about it from (this seems to suggest that [[INDI]] might not be aware about [[LEAKED_1.mp4]] being public on the channel, from where the file was shown). He also warns the viewer that "they don't want that file", before [[710 NPP|7/10 NPP]] steps in and chastises [[INDI]] for being bad. [[INDI]] apologizes, then some viewers joke about [[710 NPP|7/10 NPP]] being [[INDI]]'s dad which prompts him to say that he doesn't want to be responsible for "that thing" (implying that [[INDI]] isn't a person at all), but the reason why he has to monitor his activity is because he tends to send rogue signals to ESPaP stations.

Stream proceeds as normal once more with some minor interferences. [[Channel 14]] pops up once again, with [[INDI]] trying and failing to fix it. [[710 NPP|7/10 NPP]] tries to troubleshoot with him, asking if he tried "re-entering the CC entries", to which [[INDI]] says that he already did so. [[710 NPP|7/10 NPP]] then expresses confusion as to why their conversation switched over to the YouTube chat (which implies that their chat was originally meant for the [[Private Room]] instead), [[INDI]] asks if he entered something wrong, to which [[710 NPP|7/10 NPP]] tells him to shut up and to get back to something more secure than the livestream's chat.

After the [[Station Timer]] pops back up as normal from the interference, [[INDI]] tells [[710 NPP|7/10 NPP]] that he fixed the stream, referring to him as "[[Kepler]]" and revealing his true alias, to which Kepler panics a little at [[INDI]] for the mistake. [[INDI]] apologizes for the mistake and then adds "it's not like He can see us anyways", until he also panics at the gravity of the situation and proposes to end the comments, but unfortunately he can't do so because he can't "get to the registration (misspelled as ''registragion'') for it", meaning that he has certain restrictions on what he can do with the channel. But then [[INDI]] gets a brilliant idea: end the livestream early! [[Kepler]] almost warns [[INDI]] against this, but [[INDI]] tells him not to worry as "the data will be saved in the COMs" (whatever that means). Shortly afterwards, the livestream abruptly ends.

## Key Events

- Stream restarts due to [[REN]]
- [[710 Tone|7/10 Tone]] identifies themselves as [[INDI]], rejecting "7/10 Tone" designation
...
- [[Kepler]]'s involvement with [[TTH]] solution confirmed, possibly bribed them to not monitor the signals
- [[710 NPP|7/10NPP]] warns [[INDI]] about "[[He]]" discovering their activities
- [[710 NPP|7/10NPP]] clarifies relationship: not parental figure, but monitors [[INDI]] to prevent rogue ESPaP signals
